...
| Console Ninja                  | [![Badge for version for Visual Studio Code extension](https://flat.badgen.net/vs-marketplace/v/WallabyJs.console-ninja?icon=visualstudio&color=blue)](https://marketplace.visualstudio.com/items?itemName=WallabyJs.console-ninja) [![Installs](https://flat.badgen.net/vs-marketplace/i/WallabyJs.console-ninja?color=blue)](https://marketplace.visualstudio.com/items?itemName=WallabyJs.console-ninja) [![Rating](https://flat.badgen.net/vs-marketplace/rating/WallabyJs.console-ninja?color=blue)](https://marketplace.visualstudio.com/items?itemName=WallabyJs.console-ninja)                                                                                           |
