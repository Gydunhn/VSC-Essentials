# Special Edition of VSC Essentials - Extension Pack for AFP PLV Devs
...
This **Specia Edition** of the extension pack is for a series of very specific projects in which I am currently involved; projects with multiple repositories that share the same stack of technologies transversally.
...
``` json
{
    ...
    /**
     * * Official VSC Essentials Config
     */
